...
Users running NMS 1.38 will need to use the [latest beta version](https://github.com/matthew-humphrey/nmssavetool/releases/tag/v2.0.1.6-beta-4)

Users running NMS 1.37 and earlier can use the [latest release version](https://github.com/matthew-humphrey/nmssavetool/releases/latest)
